...
$surahs = [
    ...
    ["name" => "Al-Masad", "ayah_count" => 5],
    ["name" => "Al-Ikhlas", "ayah_count" => 4],
    ["name" => "Al-Falaq", "ayah_count" => 5],
    ["name" => "An-Nas", "ayah_count" => 6]
];

// Randomly select a Surah and Ayah
$surah_number = rand(1, 114);
$ayah_number = rand(1, $surahs[$surah_number - 1]['ayah_count']);

// API URL
$url = "https://api.quran.com/api/v4/verses/by_key/{$surah_number}:{$ayah_number}?translations=131,33";
...
// Access translation and display Surah name and Ayah number
if (isset($x->verse->translations[0]->text)) {
    $ayah_text = $x->verse->translations[0]->text;
    $surah_name = $surahs[$surah_number - 1]['name'];
} else {
}
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Center the fieldset on the page */
        body {
            display: flex;
            align-items: center;
...
<pre>
    ...
    <fieldset>
        ...
        <p class="ayah-text"><?php echo "{$ayah_text}"; ?></p>
        <p class="ayah-source">- <?php echo "Surah {$surah_name}, {$ayah_number}"; ?></p>
    </fieldset>
</body>
